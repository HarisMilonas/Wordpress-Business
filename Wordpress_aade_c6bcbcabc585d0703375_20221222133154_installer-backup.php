...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Wordpress_aade_c6bcbcabc585d0703375_20221222133154_archive.zip';
        const ARCHIVE_SIZE       = '71654611';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'c6bcbca-22133154';
        const SECONDARY_PACKAGE_HASH = '608eedd-22133154';
        const VERSION            = '1.5.1';
